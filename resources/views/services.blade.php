...
<div class="container">
    <div class="pagini">
        ...
        <a href="services" class="pagini-text-mic">{{__('site.services-page')}} </a>
    </div>
    <div class="page-title">{{__('site.services')}}</div>
    <div class="services-description">{{settings('services.description')}}</div>
    <div class="services-elements">
        @php ($delay_contor = 0)
        @foreach($services as $item)
        <a href="service-detail/{{$item->slug}}" class="service-element" data-aos-delay="{{$delay_contor*150}}"
            data-aos-easing="ease-in-sine" data-aos="fade-right">
            <div class="service-image"><img src="{{ route('thumb', ['width:260', $item->image]) }}" class="full-width">
            </div>
    ...
    <div class="services-elemente-mobile">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                @foreach($services as $item)
                <div class="swiper-slide">
                    <a href="service-detail/{{$item->id}}" class="service-element"
                        data-aos-delay="{{$delay_contor*150}}" data-aos-easing="ease-in-sine" data-aos="fade-right">
    ...
    <form class="pages-form" action='{{ action("ContactController@send_appointment") }}' method="post">
        <div class="form-title">{{__('site.make')}}</div>
        ...
        <div class='form-top' data-aos-delay="1500" data-aos="fade-right">
            <div class="form-top-element-modificat">
                ...
                <div class="select-container">
                    <input class="form-input datepicker-here" data-position="left top" type="text" id="date" name="date"
                        data-language='en'>
    ...
    <div class="testimonials-container">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a class="testimonial-item inline" data-src="#person-id-{{$item['id']}}">
                        <div class="testimonial-flex">
                            {{-- <div class="testimonial-message">{{$item->message}}</div> --}}
                        <div class="testimonial-message">{{ substr(strip_tags($item->message), 0, 100) }}...</div>
...
<div style="display:none">
    ...
    <div class="fancy-testimonial-container" id="person-id-{{$person['id']}}">
        <div class="fancy-testimonial-text">{{$person->message}}</div>
        <div class="fancy-testimonial-name">{{$person->name}}</div>
    </div>
    @endforeach
</div>
@endsection
